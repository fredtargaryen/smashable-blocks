...
public class CustomRegistries {
    public static final ResourceKey<Registry<List<SmashableBehaviourParent>>> BLOCK_REGISTRY_KEY = ResourceKey.createRegistryKey(DataReference.getResourceLocation("block"));
